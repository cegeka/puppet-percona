...
describe 'percona::server' do
  ...
  context 'with parameters' do
    context 'version_shared_compat => 5.5.31-rel30.3.520.rhel6, version_shared => 5.5.31-rel30.3.520.rhel6, version_server => 5.5.31-rel30.3.520.rhel6, version_client => 5.5.31-rel30.3.520.rhel6' do
